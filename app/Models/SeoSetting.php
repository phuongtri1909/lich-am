...
class SeoSetting extends Model
{
    ...
    public static function getBlogSeo($blog, $baseSeo = null)
    {
        ...
        return (object) [
            ...
            'keywords' => $keywords,
            'thumbnail' => $blog->image ? asset('storage/' . $blog->image) : ($baseSeo ? $baseSeo->thumbnail_url : asset('assets/images/dev/Thumbnail.png'))
        ];
    }
    ...
    public static function getProjectSeo($project, $baseSeo = null)
    {
        ...
        $keywords .= ', Cosmopark, dự án';

        return (object) [
            'title' => $title,
            'description' => $description,
            'keywords' => $keywords,
            'thumbnail' => $project->hero_image ? asset('storage/' . $project->hero_image) : ($baseSeo ? $baseSeo->thumbnail_url : asset('assets/images/dev/Thumbnail.png'))
        ];
    }
}

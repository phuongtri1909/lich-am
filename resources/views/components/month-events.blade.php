@props(['solarHolidays' => [], 'historicalEvents' => [], 'month'])

@push('styles')
    @vite('resources/assets/frontend/css/components/month-events.css')
@endpush

@if(!empty($solarHolidays) || !empty($historicalEvents))
<div class="month-events-section">
    <div class="events-content">
        <div class="events-columns">
            @if(!empty($solarHolidays))
            <!-- Ngày lễ dương lịch -->
            <div class="events-column holidays-column">
                <h4 class="events-title">Ngày lễ dương lịch tháng {{ $month }}</h4>
            ...
            <!-- Sự kiện lịch sử -->
            <div class="events-column history-column">
                <h4 class="events-title">Sự kiện lịch sử tháng {{ $month }}</h4>
                <div class="events-list">
                    @foreach($historicalEvents as $event)
                        <div class="event-item history-item">
                            <div class="event-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none"></rect>
